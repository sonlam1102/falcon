...
if __name__ == "__main__":
    # processor, model = load_peft_model_vision("./model/explanation_llms/Qwen2.5-VL-3B-Instruct-new-2/", flash_attention=True)
    # processor, model = load_peft_model_vision("/data/huggingface_models/Qwen2.5-VL-32B-Instruct", flash_attention=True, quantize=True)
    ...
    with open('./results/explanation/mocheg-qwen3vl_32b.json', 'w', encoding='utf-8') as f:
    ...
    with open('./results/explanation/finfact-qwen3vl_32b.json', 'w', encoding='utf-8') as f:
